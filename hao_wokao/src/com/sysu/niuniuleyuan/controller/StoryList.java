	...
	private class HttpTask extends AsyncTask<String, Object, Object>{
		...
		protected Object doInBackground(String... params) {
			try{
				...
				InputStream inputStreamtest=conn.getInputStream();
				CacheFunction cacheFunction=new CacheFunction();
				InputStream inputStream2 = null;
				inputStream2=cacheFunction.store("1234", "hao", inputStreamtest);
				InputStream test=cacheFunction.fetch("1234", "hao");
				String jsonString = DataFunction.inputstreamToString(inputStream2);
